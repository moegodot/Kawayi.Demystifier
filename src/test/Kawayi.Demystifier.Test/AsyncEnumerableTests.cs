    ...
    public class AsyncEnumerableTests
    {
        ...
        public async Task DemystifiesAsyncEnumerable()
        {
            ...
            var expected = string.Join("", new[] {
                "   at async IAsyncEnumerable<int> Kawayi.Demystifier.Test.AsyncEnumerableTests.Throw(CancellationToken cancellationToken)+MoveNext()",
                "   at async IAsyncEnumerable<long> Kawayi.Demystifier.Test.AsyncEnumerableTests.Start(CancellationToken cancellationToken)+MoveNext() x N",
                "   at async Task Kawayi.Demystifier.Test.AsyncEnumerableTests.DemystifiesAsyncEnumerable() x N"
            });
