...
public class MixedStack
{
    ...
    {
        "IEnumerable<string> Kawayi.Demystifier.Test.MixedStack.Iterator()+MoveNext()",
        "string string.Join(string separator, IEnumerable<string> values)",
        "string Kawayi.Demystifier.Test.MixedStack+GenericClass<T>.GenericMethod<V>(ref V value)",
        "async Task<string> Kawayi.Demystifier.Test.MixedStack.MethodAsync(int value)",
        "async ValueTask<string> Kawayi.Demystifier.Test.MixedStack.MethodAsync<TValue>(TValue value)",
        "(string val, bool) Kawayi.Demystifier.Test.MixedStack.Method(string value)",
        "ref string Kawayi.Demystifier.Test.MixedStack.RefMethod(string value)",
        "(string val, bool) Kawayi.Demystifier.Test.MixedStack.s_func(string s, bool b)",
        "void Kawayi.Demystifier.Test.MixedStack.s_action(string s, bool b)",
        "void Kawayi.Demystifier.Test.MixedStack.Start((string val, bool) param)"
