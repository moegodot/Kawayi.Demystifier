...
namespace Kawayi.Demystifier.Test
{
    public class RecursionTests
    {
        ...
        public async Task DemystifiesAsyncRecursion()
        {
            ...
            Assert.Contains("   at async Task<int> Kawayi.Demystifier.Test.RecursionTests.RecurseAsync(int depth) x N", traces);
        }
        ...
        public void DemystifiesRecursion()
        {
            ...
            Assert.Contains("   at int Kawayi.Demystifier.Test.RecursionTests.Recurse(int depth) x N", traces);
        }
